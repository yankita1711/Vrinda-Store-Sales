...
This project is based on the Vrinda Store Sales Data Analysis project by Rishabh Mishra.
The objective of this project is to analyze store sales data and identify customer purchasing patterns to help improve sales performance in 2023.

Business Questions Solved
Compare sales and orders using a single dashboard
